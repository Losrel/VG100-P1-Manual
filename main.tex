...
\newcommand{\ie}{i.\,e.,}
\newcommand{\eg}{e.\,g..}
\newcommand{\tle}{Manual of Rube Goldberg Machine for a Study Room}
...
\begin{figure}[b]
  ...
  \raggedleft
  \includegraphics[width=4cm]{umsjtuji}\\
\end{figure}
\begin{abstract}
